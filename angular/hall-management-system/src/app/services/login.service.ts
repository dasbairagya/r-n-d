...
export class LoginService {
  ...
  login(index_signin,password_signin){
    ...
    return this.http.post("http://localhost:4200/hall-management-system/api/login.php",{"index_signin":index_signin,"password_signin":password_signin}).map(res=>res.json());
  }
  getDetails(){
